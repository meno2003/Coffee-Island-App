...
export default function DueDiligencePMScreen({ onBack }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const fileName = `DueDiligencePM_${staffName}_${new Date().toISOString()}.html`;
      ...
      >
        ...
        <View style={styles.contentWrapper}>
          <View style={styles.formHeader}>
            <Text style={styles.formTitle}>Due Diligence PM</Text>
          </View>
