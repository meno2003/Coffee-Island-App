...
export default function ClosingChecklistScreen({ onBack }) {
  ...
  const checklistItems = [
    {
      id: 'cash_register',
      text: 'Count and reconcile cash register. Ensure all transactions are properly recorded.',
      category: 'Financial'
    },
    {
      id: 'equipment_shutdown',
      text: 'Turn off all coffee machines, grinders, and other electrical equipment safely.',
      category: 'Equipment'
    },
    {
      id: 'deep_clean_equipment',
      text: 'Deep clean all coffee equipment, espresso machines, and brewing tools.',
      category: 'Cleaning'
    },
    {
      id: 'sanitize_surfaces',
      text: 'Sanitize all work surfaces, counters, and food preparation areas.',
      category: 'Cleaning'
    },
    {
      id: 'clean_floors',
      text: 'Sweep and mop all floors thoroughly, including behind equipment.',
      category: 'Cleaning'
    },
    {
      id: 'empty_bins',
      text: 'Empty all waste bins and replace liners. Take out garbage and recycling.',
      category: 'Cleaning'
    },
    {
      id: 'restock_supplies',
      text: 'Restock cups, napkins, stirrers, and other customer supplies for next day.',
      category: 'Preparation'
    },
    {
      id: 'secure_perishables',
      text: 'Store all perishable items properly. Check refrigerator temperatures.',
      category: 'Food Safety'
    },
    {
      id: 'lock_storage',
      text: 'Secure all storage areas, cash registers, and valuable equipment.',
      category: 'Security'
    },
    {
      id: 'lights_ac',
      text: 'Turn off all lights, music, and adjust AC/heating for overnight.',
      category: 'Utilities'
    },
    {
      id: 'outdoor_furniture',
      text: 'Secure outdoor furniture and clean outdoor seating area.',
      category: 'Outside'
    },
    {
      id: 'final_walkthrough',
      text: 'Complete final walkthrough to ensure all areas are clean and secure.',
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const fileName = `ClosingChecklist_${staffName}_${new Date().toISOString()}.html`;
      ...
      const response = await fetch("https://content.dropboxapi.com/2/files/upload", {
        ...
        headers: {
          ...
          "Dropbox-API-Arg": JSON.stringify({
            path: `/EveningChecklists/${fileName}`,
            mode: "add",
            autorename: true,
            mute: false,
          }),
      ...
      if (response.ok) {
        Alert.alert("✅ Success", "Checklist saved and uploaded!");
      } else {
      ...
      >
        ...
        <View style={styles.contentWrapper}>
          <View style={styles.formHeader}>
            <Text style={styles.formTitle}>Closing Checklist</Text>
          </View>
